<div class="row">
	...
	<div class="col-sm-10 col-xs-12">
		<form>
			...
			<input type="text" data-field="veegie-blog-comments:name" title="Blog Name" class="form-control" placeholder="My Blog"><br />
			<label>Link to your blog</label> <br /><small>Comma-separated for more than one blog</small>
			<input type="text" data-field="veegie-blog-comments:url" title="Blog URL" class="form-control" placeholder="http://blog.mydomain.com"><br />
			...
			<input type="text" data-field="veegie-blog-comments:cid" title="Category ID" class="form-control" placeholder="1"><br />
			...
			<select data-field="veegie-blog-comments:compose-location" class="form-control">
